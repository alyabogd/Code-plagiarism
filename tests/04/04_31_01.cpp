...
template<typename X> inline void print(const vector<X>& a, ostream& out) {
    out << sz(a) << endl; forn(i, sz(a)) out << a[i] << ' '; out << endl;
    }
template<typename X> inline void print(const vector<X>& a) {
    print(a, cerr);
    }
template<typename X> inline void print(X* a, int n, ostream& out) {
    out << n << endl; forn(i, n) out << a[i] << ' '; out << endl;
    }
template<typename X> inline void print(X* a, int n) {
    print(a, n, cerr);
     }
